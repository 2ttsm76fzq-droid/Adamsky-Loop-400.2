...
# Date: 2025-10-08 (CET)
# Version: 402.6 (Integrated: Adamsky Loop v402.0 + Query Skill v402.5 + 6 Enhancements)
...
class EngineConfig:
    ...
    # NEW v402.6: Emergency Brake Config
...
# ============================================================
# CZĘŚĆ V: QUERY SKILL INTEGRATION (v402.6)
# ============================================================
    ...
    def process(self, question: str, answer: str, context: dict = None,
        ...
        if context.get("export_audit", False):
            self.query_skill.export_audit_log(
                f"adamsky_audit_{int(time.time())}.csv",
                record
            )
